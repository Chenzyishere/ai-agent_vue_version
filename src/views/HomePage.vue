  ...
  <div class="home-page">
    <header class="header">
      <div class="header-left">
        <span class="logo-text">Chenzyishere LLM Chat Test</span>
      </div>
        ...
        <div class="search-container" @click="handleSearchClick">
          <div class="search-input">
            ...
            <input
              ...
              v-model="searchText"
            />
            <div class="shortcut-key">⌘ K/Ctrl K 快速打开或关闭搜索框</div>
          </div>
        </div>
        <a
    ...
    <main class="main-content">
      <div class="hero-section">
        ...
        <p class="description">
          一个强大的 AI 聊天助手，基于大语言模型，为您提供智能对话体验
        </p>
        <div class="features">
  ...
  .hero-section {
    ...
    .start-button {
      ...
      .liquid {
        ...
        box-shadow: inset 0 0 50px rgb(0, 145, 235);
        transition: 0.5s;
